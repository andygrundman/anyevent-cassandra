...
use constant KEYS => 0;
package AnyEvent::Cassandra::API::Compression;
use constant GZIP => 1;
use constant NONE => 2;
package AnyEvent::Cassandra::API::CqlResultType;
use constant ROWS => 1;
use constant VOID => 2;
use constant INT => 3;
...
package AnyEvent::Cassandra::API::CounterColumn;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::CounterColumn->mk_accessors( qw( name value ) );
...
package AnyEvent::Cassandra::API::CounterSuperColumn;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::CounterSuperColumn->mk_accessors( qw( name columns ) );
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem12 = undef;
            $elem12 = new AnyEvent::Cassandra::API::CounterColumn();
...
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::ColumnOrSuperColumn->mk_accessors( qw( column super_column counter_column counter_super_column ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{counter_column} = new AnyEvent::Cassandra::API::CounterColumn();
      ...
      /^4$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{counter_super_column} = new AnyEvent::Cassandra::API::CounterSuperColumn();
...
package AnyEvent::Cassandra::API::SchemaDisagreementException;
use base qw(AnyEvent::Cassandra::Thrift::TException);
use base qw(Class::Accessor);
      ...
      /^1$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem26 = undef;
            $elem26 = new AnyEvent::Cassandra::API::IndexExpression();
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem33 = undef;
            $elem33 = new AnyEvent::Cassandra::API::ColumnOrSuperColumn();
      ...
      /^13$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem56 = undef;
            $elem56 = new AnyEvent::Cassandra::API::ColumnDef();
      ...
      /^5$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem70 = undef;
            $elem70 = new AnyEvent::Cassandra::API::CfDef();
...
package AnyEvent::Cassandra::API::CqlRow;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::CqlRow->mk_accessors( qw( key columns ) );
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem79 = undef;
            $elem79 = new AnyEvent::Cassandra::API::Column();
...
package AnyEvent::Cassandra::API::CqlResult;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::CqlResult->mk_accessors( qw( type rows num ) );
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem86 = undef;
            $elem86 = new AnyEvent::Cassandra::API::CqlRow();
