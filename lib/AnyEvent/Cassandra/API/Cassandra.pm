      ...
      /^0$/ && do{      if ($ftype == TType::MAP) {
        {
          ...
          for (my $_i106 = 0; $_i106 < $_size102; ++$_i106)
          {
            ...
            $xfer += $input->readString(\$key107);
            {
              ...
              {
                my $elem114 = undef;
                $elem114 = new AnyEvent::Cassandra::API::ColumnOrSuperColumn();
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem139 = undef;
            $elem139 = new AnyEvent::Cassandra::API::KeySlice();
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem146 = undef;
            $elem146 = new AnyEvent::Cassandra::API::KeySlice();
...
package AnyEvent::Cassandra::API::Cassandra_add_args;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::Cassandra_add_args->mk_accessors( qw( key column_parent column consistency_level ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      last; };
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{column} = new AnyEvent::Cassandra::API::CounterColumn();
        $xfer += $self->{column}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package AnyEvent::Cassandra::API::Cassandra_add_result;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::Cassandra_add_result->mk_accessors( qw( ) );
...
package AnyEvent::Cassandra::API::Cassandra_remove_counter_args;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::Cassandra_remove_counter_args->mk_accessors( qw( key path consistency_level ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      last; };
      /^2$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{path} = new AnyEvent::Cassandra::API::ColumnPath();
...
package AnyEvent::Cassandra::API::Cassandra_remove_counter_result;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::Cassandra_remove_counter_result->mk_accessors( qw( ) );
            ...
            $xfer += $input->readString(\$key153);
            {
              ...
              for (my $_i159 = 0; $_i159 < $_size155; ++$_i159)
              {
                ...
                $xfer += $input->readString(\$key160);
                {
                  ...
                  {
                    my $elem167 = undef;
                    $elem167 = new AnyEvent::Cassandra::API::Mutation();
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem194 = undef;
            $elem194 = new AnyEvent::Cassandra::API::KsDef();
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem201 = undef;
            $elem201 = new AnyEvent::Cassandra::API::TokenRange();
...
sub read {
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      last; };
      /^2$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{sde} = new AnyEvent::Cassandra::API::SchemaDisagreementException();
...
package AnyEvent::Cassandra::API::Cassandra_execute_cql_query_args;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::Cassandra_execute_cql_query_args->mk_accessors( qw( query compression ) );
...
package AnyEvent::Cassandra::API::Cassandra_execute_cql_query_result;
use base qw(Class::Accessor);
AnyEvent::Cassandra::API::Cassandra_execute_cql_query_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new AnyEvent::Cassandra::API::CqlResult();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
sub recv_login{
  ...
  if ($mtype == TMessageType::EXCEPTION) {
    my $x = new AnyEvent::Cassandra::Thrift::TApplicationException();
    $x->read($self->{input});
...
sub send_add{
  ...
  my $args = new AnyEvent::Cassandra::API::Cassandra_add_args();
  $args->{key} = $key;
  $args->{column_parent} = $column_parent;
  $args->{column} = $column;
  $args->{consistency_level} = $consistency_level;
...
sub recv_add{
  ...
  my $result = new AnyEvent::Cassandra::API::Cassandra_add_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_remove_counter{
  ...
  my $args = new AnyEvent::Cassandra::API::Cassandra_remove_counter_args();
  $args->{key} = $key;
  $args->{path} = $path;
  $args->{consistency_level} = $consistency_level;
  $args->write($self->{output});
...
sub recv_remove_counter{
  ...
  my $result = new AnyEvent::Cassandra::API::Cassandra_remove_counter_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_execute_cql_query{
  ...
  my $args = new AnyEvent::Cassandra::API::Cassandra_execute_cql_query_args();
  $args->{query} = $query;
...
sub recv_execute_cql_query{
  ...
  my $result = new AnyEvent::Cassandra::API::Cassandra_execute_cql_query_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub process {
    ...
    if (!$self->can($methodname)) {
      ...
      my $x = new AnyEvent::Cassandra::Thrift::TApplicationException('Function '.$fname.' not implemented.', AnyEvent::Cassandra::Thrift::TApplicationException::UNKNOWN_METHOD);
...
sub process_system_add_column_family {
    ...
    eval {
      ...
      $result->{ire} = $@;
        }; if( UNIVERSAL::isa($@,'AnyEvent::Cassandra::API::SchemaDisagreementException') ){ 
      $result->{sde} = $@;
    }
