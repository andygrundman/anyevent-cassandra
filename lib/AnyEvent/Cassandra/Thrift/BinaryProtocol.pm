...
use AnyEvent::Cassandra::Thrift::Protocol;
...
#
package AnyEvent::Cassandra::Thrift::BinaryProtocol;
use base('AnyEvent::Cassandra::Thrift::Protocol');
...
sub readMessageBegin
{
    ...
    if (($version & VERSION_MASK) > 0) {
      if (($version & VERSION_MASK) != VERSION_1) {
        die new AnyEvent::Cassandra::Thrift::TException('Missing version identifier')
      }
...
#
package AnyEvent::Cassandra::Thrift::BinaryProtocolFactory;
use base('AnyEvent::Cassandra::TProtocolFactory');
...
sub getProtocol{
    ...
    return new AnyEvent::Cassandra::Thrift::BinaryProtocol($trans);
}
