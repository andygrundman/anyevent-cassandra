...
# Protocol exceptions
#
package AnyEvent::Cassandra::TProtocolException;
...
#
package AnyEvent::Cassandra::Thrift::Protocol;
...
sub skip
{
    ...
    die new AnyEvent::Cassandra::Thrift::TException("Type $type not recognised --- corrupt data?");
...
#
package AnyEvent::Cassandra::TProtocolFactory;
